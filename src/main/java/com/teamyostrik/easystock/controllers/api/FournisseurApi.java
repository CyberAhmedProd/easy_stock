...
public interface FournisseurApi {
    ...
    @PostMapping(value = Constants.APP_ROOT+"fournisseur",produces = MediaType.APPLICATION_JSON_VALUE,consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    public ResponseEntity<FournisseurDto> getById(@PathVariable("id_fournisseur") Integer idFournisseur);

    @GetMapping(value = Constants.APP_ROOT+"fournisseur",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = Constants.APP_ROOT+"fournisseur/{id_fournisseur}")
